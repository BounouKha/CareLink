...
def test_service_request_names():
    ...
    try:
        ...
        family_patient_user = User.objects.get(email='fpatient1@carelink.be')
        ...
        print("❌ Error testing service requests: Family patient user 'fpatient1@carelink.be' not found")
        return False
    except Exception as e:
