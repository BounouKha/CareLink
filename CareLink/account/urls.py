...
from account.views.consent import ConsentStorageView, UserConsentHistoryView, ConsentWithdrawalView, consent_audit_export, consent_stats, AdminConsentListView
...
urlpatterns += [
    ...
    path('logs/stats/', LogStatsView.as_view(), name='logs_stats'),    # Consent API endpoints
