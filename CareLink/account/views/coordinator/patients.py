        ...
        patient_data = [
            {
                ...
                "emergency_contact_name": patient.user.preferences.emergency_contact_name if patient.user and hasattr(patient.user, 'preferences') else None,
                "emergency_contact_phone": patient.user.preferences.emergency_contact_phone if patient.user and hasattr(patient.user, 'preferences') else None,
                "emergency_contact_relationship": patient.user.preferences.emergency_contact_relationship if patient.user and hasattr(patient.user, 'preferences') else None,
