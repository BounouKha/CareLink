...
def test_provider_endpoints():
    ...
    login_data = {
        "email": "REMOVED_EMAIL",  # Replace with actual admin email
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            access_token = "REMOVED_JWT_TOKEN.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzUwNzY0MTM2LCJpYXQiOjE3NTA3NjMyMzYsImp0aSI6Ijc1OTZkMTFkODBjZTQxZWM5ZTUwMThlOGI5ZTkzNmY2IiwidXNlcl9pZCI6NjcsImlzX3N1cGVydXNlciI6ZmFsc2V9.0LycFeFeaXyCNgRGCYCPJU4PmuSESzV3T7t_zrcciWA"
